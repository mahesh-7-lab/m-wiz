...
echo -e "$red                                ⫸$ylo  Mahesh-7-lab $red ⫷$rset"
echo -e "$red                          ⫸$grn  github.com/Mahesh-7-lab $red⫷$rset"
echo " "
echo " "
...
echo "  "                            ＞Msf-installer is a official tool made for metasploit＜$rset"
echo " "
...
echo " "
echo -e "$cyan                       click$grn ENTER$cyan to go back into msf-installer menu$rset"
echo " "
read punch
fi
cd $HOME/m-wiz
...
echo -e "$grn               ＞＞＞＞＞＞＞＞＞＞＞$ylo [EXIT]$grn ＜＜＜＜＜＜＜＜＜＜＜＜$rset"
echo " "
echo -e "$cyan                        click$grn ENTER$cyan to go back into msf-istaller menu$rset"
echo " "
read punch
fi
cd $HOME/m-wiz
...
echo -e "$grn               ＞＞＞＞＞＞＞＞＞＞＞$ylo [EXIT]$grn ＜＜＜＜＜＜＜＜＜＜＜＜$rset"
echo " "
echo -e "$cyan                        click$grn ENTER$cyan to go back into msf-installer
menu$rset"
echo " "
read punch
fi
...
echo -e "$grn               ＞＞＞＞＞＞＞＞＞＞＞$ylo [EXIT]$grn ＜＜＜＜＜＜＜＜＜＜＜＜$rset"
echo " "
echo -e "$cyan                        click$grn ENTER$cyan to go back into msf-inatller menu$rset"
echo " "
read punch
fi
cd $HOME/m-wiz
...
am start -a android.intent.action.VIEW -d https://www.youtube.com/channel/UCJKDmdd7ceo2r-SafEjseEg
echo " "
echo " "
echo -e "$grn               ＞＞＞＞＞＞＞＞＞＞＞$ylo [EXIT]$grn ＜＜＜＜＜＜＜＜＜＜＜＜$rset"
echo " "
